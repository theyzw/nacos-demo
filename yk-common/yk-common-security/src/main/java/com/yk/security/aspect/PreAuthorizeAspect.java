...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.yk.security.annotation.RequiresLogin) || "
        + "@annotation(com.yk.security.annotation.RequiresPermissions) || "
        + "@annotation(com.yk.security.annotation.RequiresRoles)";
